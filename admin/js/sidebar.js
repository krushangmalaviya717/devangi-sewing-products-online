...
(function () {
    ...
    const menuSections = [
        ...
        },
        {
            label: 'Custom Farma',
            items: [
                { href: 'custom-orders.html', icon: 'custom_orders', label: 'Custom Orders', permission: 'orders' },
                { href: 'farma-builder.html', icon: 'farma_builder', label: 'Form Builder', permission: 'settings' }
            ]
        },
        {
            label: 'Analytics',
    ...
    const icons = {
        ...
        custom_orders: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>`,
        farma_builder: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>`
    };
